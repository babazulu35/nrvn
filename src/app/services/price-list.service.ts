...
@Injectable()
export class PriceListService extends  BaseDataService {
  ...
  constructor(http : Http, storeService : StoreService, authenticationService:AuthenticationService){
    super(http, 'PPriceList', storeService, authenticationService);
  }
  getRawData() : PriceList[]{
    return this.storeService.getData('PPriceList');
  }

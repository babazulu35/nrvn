...
@Component({
    selector: 'app-products-bundles',
    templateUrl: './products-bundles.component.html',
    styleUrls: ['./products-bundles.component.scss'],
    entryComponents: [ContextMenuComponent],
    providers: [ProductService]
})
export class ProductsBundlesComponent implements OnInit {
    ...
    constructor(
        ...
        // productService.setQueryParams({ filter: [{ filter: 'IsBundle eq true' }], sort: [], pageSize: 10, page: 1 });
    }

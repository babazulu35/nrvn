...
@Component({
	selector: 'app-events-multiple-performance',
	templateUrl: './events-multiple-performance.component.html',
	styleUrls: ['./events-multiple-performance.component.scss'],
	entryComponents: [ContextMenuComponent],
})
export class EventsMultiplePerformanceComponent implements OnInit {
	@HostBinding('class.or-events-multiple-performance') true;
	...
	constructor(
		...
		eventService.setQueryParams({protectedFilter: 'PerformanceCount gt 1', sort : [], pageSize: this.pageSize, page : 1});
	}
